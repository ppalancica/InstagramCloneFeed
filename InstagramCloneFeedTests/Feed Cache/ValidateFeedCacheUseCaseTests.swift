...
class ValidateFeedCacheUseCaseTests: XCTestCase {
    ...
    /*func test_validateCache_doesNotDeleteLessThanSevenDaysOldCacheV1() {
    ...
    /*func test_validateCache_deletesSevenDaysOldCacheV1() {
        let feed = uniqueImageFeed()
        let fixedCurrentDate = Date()
    ...
    /*func test_validateCache_deletesMoreThanSevenDaysOldCacheV1() {
        let feed = uniqueImageFeed()
        let fixedCurrentDate = Date()
